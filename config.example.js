/* Care Log configuration.
   ...
   4. Optional: a further email can be added with { name, role: "viewer" } instead of a plain name,
      for someone who should see Meds, Chemo and Trends only, with no editing rights at all. See the
      isViewer() function and "read-only viewer" notes in firestore.rules and CLAUDE.md.
